  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      $('#btnNuevaFactura').click(function() {
        window.location = '../facturacion/facturacion.php';
      });
      ...
      $('#btnConfirmarBorrado').click(function() {
        window.location = '../facturacion/borrarfactura.php?codigofactura=' + codigofactura;
      });

      $('.botonimprimir').click(function() {
        window.open('../facturacion/pdffactura.php?' + '&codigofactura=' + $(this).get(0).dataset.codigo, '_blank');
      });
