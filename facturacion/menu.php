    ...
    <ul class="nav mt-2">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="../facturacion/categorias/administracion.html">Mantenimiento de categorías</a>
          <a class="dropdown-item" href="../facturacion/productos/administracion.html">Mantenimiento de productos</a>
          <a class="dropdown-item" href="../facturacion/clientes/administracion.html">Mantenimiento de clientes</a>
        </div>
      </li>
    </ul>
