  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function EnviarInformacionProducto(accion) {
        $.ajax({
          type: 'POST',
          url: '../facturacion/procesar.php?accion=' + accion + '&codigofactura=' + <?php echo $codigofactura ?>,
          data: producto,
      ...
      function EnviarInformacionFactura(accion) {
        $.ajax({
          ...
          data: cliente,
          success: function(msg) {
            window.location = '../facturacion/menu.php';
          },
          error: function() {
            alert("Hay un error ..");
          }
    ...
    $('#btnConfirmarBorrado').click(function() {
      ...
      $.ajax({
        type: 'POST',
        url: '../facturacion/borrarproductodetalle.php?codigo=' + cod,
        success: function(msg) {
          RecuperarDetalle();
        },
        error: function() {
    ...
    function RecuperarDetalle() {
      $.ajax({
        type: 'GET',
        url: '../facturacion/recuperardetalle.php?codigofactura=' + <?php echo $codigofactura ?>,
